...
const articlesMock = {
    ...
    user: {
        id: '1',
        username: 'Admin',
        avatar: 'https://cs9.pikabu.ru/avatars/2254/x2254660-250255022.png',
    },
    title: 'Заголовок статьи более длинной чем два слова',
...
const ArticlesListPage = ({ className }: ArticlesListPageProps) => (
    <div className={classNames(styles.container, {}, [className])}>
        <ArticleList
            articles={new Array(16).fill(9).map((item, index) => ({
                ...articlesMock,
                id: String(index),
            }))}
            isLoading
